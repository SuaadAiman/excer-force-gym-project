...
def create_app(test_config=None):
    ...
    # This endpoint return all the training classes
    # information in the database
    # It requires a get:TrainingClasses permission
    # which the manager and client both has
    ...
    # This endpoint add a training class into the
    # database it requiers a name, description, coach id to associte
    # with the class, periods and dayes the class will be had
    # it returns the added class id and all the classes information
    # in the database
    ...
    # This endpoint deletes a training
    # class with a specified id
    # it returns the id of the deleted class
    # and a list of all the classe in the database
    # It requires a delete:TrainingClasses permission
    ...
    def delete_TrainingClass(jwt, class_id):
        ...
        trainingClass = TrainingClass.query.filter_by(
    ...
    # this endpoint updates the periodes and dayes of a training
    # class specified by an id it returns the id of the updated
    # class and a list of all the classe in the database
    # It requires a patch:TrainingClasses permission which
    # the manager has
  ...
  '''
    # This endpoint return all the coaches
    # information in the database
    # It requires a get:Coaches permission which
    # the manager and client both has
    ...
    # This endpoint add a coach into the database it
    # requiers a name and a description of the coach
    # It returns the added coach id and all the
    # coaches information in the database.
    ...
    # it returns the id of the deleted coach and a
    # list of all the coaches in the database
    ...
    def delete_Coach(jwt, coach_id):
        ...
        traingingClass = TrainingClass.query.filter_by(
            coachId=coach_id).one_or_none()
